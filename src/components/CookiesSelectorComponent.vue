...
<div class="q-py-xs"><vue-markdown :source="md_text" /></div>

    </q-scroll-area>
  <div class="row">
    <q-checkbox :disable="!scrolledToBottom" v-model="checked" label="Ich habe diese Informationen zur Kenntnis genommen und verstanden."></q-checkbox>
    <q-btn :disable="!checked" label="Click here!" @click="enableCookies" />
